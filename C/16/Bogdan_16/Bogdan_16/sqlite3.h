...
** In such cases, the
** mutex must be rced an equal number of times before another thread
...
** behavior.)^
**
** ^The sqlite3_mutex_leave() routine rcs a mutex that was
...
** or because the last process to have the database opened rced without
