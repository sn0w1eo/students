/*/——————————————————————————————————————————————\
 |                                                |
 | Функция GetMemory выделяет/перераспределяет    |
 | память для хранения данных типа phonebook.     |
 |                                                |
 | Функция FreeMemory освобождают всю память      |
 | выделенную программе раннее                    |
 |                                                |
 \————————————————————————————————————————————————/*/
